			            ...
			            bucket_name, shared_user_name)
{
    ...
    var url = "http://54.173.39.128:8000/share" +
	    "?user="       + user_name +
	    "&pass="    + password_hash +
...
main = function ()
{
	...
	break;
    case 1:
	Status.concat("Shared user already has access." + "<br>");
	return false;
    case 2:
	Status.concat("Shared user does not exist." + "<br>");
	return false;
    case 3:
	Status.concat("User does not have access to this bucket." + "<br>");
	return false;
    case 4:
    ...
    Status.concat("Successfully shared bucket: " + bucket_name_g + " with user: " + shared_user_name_g + "<br>");
    return true;
}
