...
//	alert("in onload or onreadystatechange: " + xhr.status + "," +  xhr.readyState +
//	      "," + xhr.HEADERS_RECEIVED + "," + headersEmitted + "," + xhr.DONE);
      try {
        if (xhr.status === 0) return; // 0 code is invalid
      } catch (e) { return; }
	
	// HTMLUNIT: 2 = this.HEADERS_RECEIVED
      if (this.readyState >= 2 && !headersEmitted) {
